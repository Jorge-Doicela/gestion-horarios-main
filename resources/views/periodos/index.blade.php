    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-8 animate-fade-in-up">
                ...
                <h1 class="text-3xl font-bold text-gray-900 mb-2">Gestión de Períodos Académicos</h1>
                <p class="text-gray-600">Administre los períodos académicos del sistema de horarios</p>
            </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($periodos as $p)
                                <tr class="hover:bg-gray-50/50 transition-all duration-200">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="w-12 h-12 bg-gradient-to-br from-orange-500 to-red-500 rounded-xl flex items-center justify-center mr-4">
                                                <span class="text-white font-bold text-lg">{{ substr($p->nombre, 0, 2) }}</span>
                                            </div>
                                            <div>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">{{ \Carbon\Carbon::parse($p->fecha_inicio)->format('d/m/Y') }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">{{ \Carbon\Carbon::parse($p->fecha_fin)->format('d/m/Y') }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @if($p->estado == 'activo')
            ...
            @if($periodos->isEmpty())
                <div class="text-center py-12 animate-fade-in-up" style="animation-delay: 0.4s;">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">No hay períodos registrados</h3>
                    <p class="text-gray-600 mb-6">Comience registrando el primer período académico del sistema.</p>
                    <a href="{{ route('periodos.create') }}" 
                       class="bg-gradient-to-r from-orange-600 to-red-600 text-white px-6 py-3 rounded-xl font-semibold hover:from-orange-700 hover:to-red-700 transition-all duration-200 transform hover:scale-105 shadow-lg">
