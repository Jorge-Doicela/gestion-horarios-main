    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 py-8">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-8 animate-fade-in-up">
                ...
                <p class="text-gray-600">Defina un nuevo rol con sus permisos correspondientes</p>
            </div>
        ...
        @endif
            ...
            @csrf
                ...
                <input type="text" name="name" value="{{ old('name') }}" required
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 bg-white/50 backdrop-blur-sm"
                        ...
                        <div class="bg-gray-50/50 rounded-xl border border-gray-200 p-6 max-h-96 overflow-y-auto">
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                @foreach ($permissions as $perm)
                                    <div class="flex items-center p-3 bg-white/70 rounded-lg border border-gray-200 hover:bg-purple-50/50 transition-all duration-200">
                    ...
                    @endforeach
                        ...
                        <div class="flex items-center justify-between text-sm">
                            <span class="text-gray-600">Total de permisos disponibles: <span class="font-semibold text-purple-600">{{ $permissions->count() }}</span></span>
                            <button type="button" onclick="selectAllPermissions()" class="text-purple-600 hover:text-purple-700 font-medium">
                                Seleccionar todos
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 pt-6">
                        <button type="submit" 
                                class="flex-1 bg-gradient-to-r from-purple-600 to-pink-600 text-white px-6 py-3 rounded-xl font-semibold hover:from-purple-700 hover:to-pink-700 transition-all duration-200 transform hover:scale-105 shadow-lg">
                        ...
                        <a href="{{ route('admin.roles.index') }}" 
                           class="flex-1 bg-white text-gray-700 px-6 py-3 rounded-xl font-semibold border-2 border-gray-300 hover:border-purple-500 hover:text-purple-600 transition-all duration-200 transform hover:scale-105 text-center">
                            <span class="flex items-center justify-center">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
