    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 py-8">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white/80 backdrop-blur-md rounded-2xl shadow-xl border border-white/20 p-8 animate-fade-in-up" style="animation-delay: 0.2s;">
                <form method="POST" action="{{ route('admin.permissions.update', $permission) }}" class="space-y-6" data-validate="true">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="name" value="{{ old('name', $permission->name) }}" required maxlength="255" pattern="[a-z0-9._-]+"
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <div class="text-xs text-gray-500">
                                <span id="name-count">{{ strlen($permission->name) }}</span>/255 caracteres
                            </div>
                        </div>
                        @error('name')
