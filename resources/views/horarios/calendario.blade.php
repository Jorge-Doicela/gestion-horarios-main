                                    ...
                                    @foreach ($dias as $dia)
                                        ...
                                        <td class="px-4 py-4 text-center align-top">
                                            @if ($clase)
                                                ...
                                                @endphp
                                                <div class="rounded-xl p-3 border-2 {{ $bgClass }} {{ $statusClass }} shadow-sm hover:shadow-md transition-all duration-200">
                                                    ...
                                                    <div class="space-y-1 text-xs text-gray-700">
                                                        ...
                                                        @if ($clase->conflictos->count())
                                                            <div class="mt-2 p-2 bg-red-100 border border-red-300 rounded-lg">
                                                                <div class="flex items-center justify-center text-red-700 font-bold text-xs">
