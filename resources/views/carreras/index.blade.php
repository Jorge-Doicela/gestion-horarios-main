    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-8 animate-fade-in-up">
                ...
                <h1 class="text-3xl font-bold text-gray-900 mb-2">Gestión de Carreras</h1>
                <p class="text-gray-600">Administre las carreras académicas del sistema de horarios</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6 animate-fade-in-up" style="animation-delay: 0.2s;">
                <div class="bg-white/80 backdrop-blur-md rounded-xl px-4 py-2 border border-white/20">
                    <span class="text-sm text-gray-600">Total de carreras:</span>
                    <span class="font-semibold text-indigo-600 ml-1">{{ $carreras->total() }}</span>
                </div>
                <div class="bg-white/80 backdrop-blur-md rounded-xl px-4 py-2 border border-white/20">
                    <span class="text-sm text-gray-600">Activas:</span>
                    <span class="font-semibold text-indigo-600 ml-1">{{ $carreras->count() }}</span>
                </div>
            </div>
            ...
            <div class="bg-white/80 backdrop-blur-md rounded-2xl shadow-xl border border-white/20 p-6 mb-6 animate-fade-in-up" style="animation-delay: 0.3s;">
                <form method="GET" action="{{ route('carreras.index') }}" class="space-y-4">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 items-center justify-between">
                        ...
                        <div class="text-sm text-gray-600">
                            Mostrando {{ $carreras->firstItem() ?? 0 }} - {{ $carreras->lastItem() ?? 0 }} de {{ $carreras->total() }} resultados
                        </div>
                    </div>
                </form>
            </div>
                                ...
                                <tr class="hover:bg-gray-50/50 transition-all duration-200">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                <div class="text-sm font-semibold text-gray-900">{{ $carrera->nombre }}</div>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-900 max-w-xs">
                                            @if($carrera->descripcion)
                                                {{ Str::limit($carrera->descripcion, 80) }}
                                            @else
                                        ...
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <form action="{{ route('carreras.destroy', $carrera) }}" method="POST" class="inline">
                                                ...
                                                <button type="submit" 
                                                        ...
                                                        data-confirm-message="¿Está seguro de eliminar la carrera '{{ $carrera->nombre }}'? Esta acción no se puede deshacer."
            ...
            @if($carreras->isEmpty())
                <div class="text-center py-12 animate-fade-in-up" style="animation-delay: 0.4s;">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">No hay carreras registradas</h3>
                    <p class="text-gray-600 mb-6">Comience creando la primera carrera académica del sistema.</p>
                    <a href="{{ route('carreras.create') }}" 
                       class="bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-6 py-3 rounded-xl font-semibold hover:from-indigo-700 hover:to-purple-700 transition-all duration-200 transform hover:scale-105 shadow-lg">
